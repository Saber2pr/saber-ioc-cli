...
var Application = /** @class */ (function () {
    ...
    Application.prototype.main = function () {
        ...
        var SymbolTemplate = this.TemplateController.getSymbolTemplate();
        var ServiceSymbolAppendedTemplate = this.TemplateController.getSymbolAppended(Name, 'Service');
        var ControllerSymbolAppendedTemplate = this.TemplateController.getSymbolAppended(Name, 'Controller');
