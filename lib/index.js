...
var Application = /** @class */ (function () {
    ...
    Application.prototype.getParams = function () {
        return saber_node_1.Terminal.getParams();
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.FileController.testSIOCModule(ServiceName, 'Service') ||
                            this.FileController.testSIOCModule(ControllerName, 'Controller'))) return [3 /*break*/, 1];
                        saber_node_1.Terminal.Print.error("Module: " + Name + " is existed!");
                        return [3 /*break*/, 10];
                    case 1:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.FileController.appendInBrace(SymbolTemplate, ServiceSymbolAppendedTemplate + "\n  " + ControllerSymbolAppendedTemplate)];
                    case 6:
                        _a.sent();
