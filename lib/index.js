...
var Application = /** @class */ (function () {
    ...
    Application.prototype.createModule = function (Name) {
        return __awaiter(this, void 0, void 0, function () {
            var ServiceName, ControllerName, IServiceName, IControllerName, ServiceTemplate, ControllerTemplate, IServiceTemplate, IControllerTemplate, SymbolTemplate, ServiceSymbolAppendedTemplate, ControllerSymbolAppendedTemplate;
            return __generator(this, function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        params = _a.sent();
                        params.forEach(function (name) { return _this.createModule(name); });
                        return [2 /*return*/];
                }
            });
        });
