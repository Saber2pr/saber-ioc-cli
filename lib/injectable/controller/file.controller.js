    ...
    FileController.prototype.appendInBrace = function (fileContent, appendContent) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!saber_node_1.Path.isExist(this.PathSrcService.symbol)) return [3 /*break*/, 1];
                        this.FileService.appendInBrace(this.PathSrcService.symbol, appendContent);
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.FileService.createFile(this.PathSrcService.symbol, fileContent)];
                    case 2:
                        _a.sent();
                        this.FileService.appendInBrace(this.PathSrcService.symbol, appendContent);
                        _a.label = 3;
