...
var FileController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.FileService.createFile(dirPath + "/" + name, content)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        saber_node_1.Terminal.Print.error(error_1.message);
                        return [3 /*break*/, 3];
    ...
    FileController.prototype.createInRoot = function (name, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.create(this.PathService.root, name + ".ts", content)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FileController.prototype.createInSrc = function (name, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.create(this.PathService.src, name + ".ts", content)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FileController.prototype.createInSrcInjectable = function (name, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.create(this.PathSrcService.injectable, name + ".ts", content)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FileController.prototype.createInSrcInterface = function (name, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.create(this.PathSrcService.interface, name + ".ts", content)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FileController.prototype.createInSrcSymbol = function (name, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.create(this.PathSrcService.symbol, name + ".ts", content)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.FileService.appendSIOCSymbolInBrace(this.PathSrcService.symbol, appendContent)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 5];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 2: return [4 /*yield*/, saber_node_1.File.createFile(this.PathSrcService.index, fileContent)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.FileService.appendSIOCModule(this.PathSrcService.index, Name)];
                    case 4:
    ...
    FileController.prototype.unshiftContent = function (appendContent) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.FileService.unshiftContent(this.PathSrcService.index, appendContent)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FileController.prototype.testSIOCModule = function (Name, type) {
        return (saber_node_1.Path.isExist(this.PathSrcService.injectable + "/" + type + "/" + Name + ".ts") ||
            saber_node_1.Path.isExist(this.PathSrcService.injectable + "/" + type + "/I" + Name + ".ts"));
    };
